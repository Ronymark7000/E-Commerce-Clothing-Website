...
<body>
	<header>
		<!-- Consist of a search bar, filter drop box and title of the webpage along with go back and add to cart button -->
		<h1>Product Store</h1>
		<br> 
		...
		<input type="submit" value="Search" />
			...
			<a href="${pageContext.request.contextPath}/Pages/AddToCart.jsp">
			<button onclick="location.href='#'" style="float: right; font-size: 30px;">Go to Cart</button>
			</a>
