	...
	<header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="${pageContext.request.contextPath}/Pages/NotProduct.jsp">Product</a></li>
    ...
    <!-- Welcome part of the webpage -->
        ...
        <section id="products">
            ...
            <div class="product">
                ...
                <a href="${pageContext.request.contextPath}/Pages/Register.jsp" class="btn">Register to Buy</a>
            </div>
